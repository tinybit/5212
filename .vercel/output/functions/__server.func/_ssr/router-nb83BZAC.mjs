...
//#region node_modules/.nitro/vite/services/ssr/assets/router-nb83BZAC.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CIIuoavk.css";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "An interactive weekly-calendar watch dial: live time, week-of-year, day, month, and date."
			}
		],
		links: [{
			rel: "stylesheet",
...
var $$splitComponentImporter = () => import("./routes-Dqmaxo3m.mjs");
